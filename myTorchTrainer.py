...
os.environ['TORCH_HOME'] = '/Users/agnih/torchhome/' #setting the environment variable
...
parser.add_argument('--data_name', type=str, default='imagenet_blurred',
                    help='data name: imagenet_blurred, tiny-imagenet-200, hymenoptera_data, CIFAR10, FashionMNIST, flower_photos')
...
parser.add_argument('--resume', default="outputs/fashionmnist_1/model_best.pth.tar", type=str, metavar='PATH',
